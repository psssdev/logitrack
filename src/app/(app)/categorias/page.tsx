...
export default function CategoriasPage() {
  ...
  const pageIsLoading = isLoadingCategories || isUserLoading || !selectedStore;
  ...
  const confirmDelete = async () => {
    ...
    try {
      const docRef = doc(firestore, 'stores', selectedStore.id, 'financialCategories', deletingCategory.id);
