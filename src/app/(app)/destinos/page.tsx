...
export default function DestinosPage() {
  ...
  const pageIsLoading = isLoadingDestinos || isUserLoading;
  ...
  const confirmDelete = async () => {
    if (!firestore || !deletingDestino || !selectedStore) return;
    try {
      const docRef = doc(firestore, 'stores', selectedStore.id, 'destinos', deletingDestino.id);
